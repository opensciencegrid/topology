...
new_org_rejected = (
    ...
    "Thank you for your pull request.\n"
    "\n"
    "Your [requested changes]({base_sha}...{head_sha}) add a new"
    " Organization to a project file, which is not allowed without explicit"
    " OSG Staff approval."
    " If this was not intentional, please consider using an Organization name"
    " that already exists in other project files.\n"
    "\n"
    "OSG Staff will need to manually review this PR.\n"
    "\n"
    "-- OSG-BOT  :mag:\n"
